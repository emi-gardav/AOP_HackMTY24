...
def show_home():
    ...
    # HTML and CSS for custom radio buttons
    st.markdown("""
        <style>
        .panel {
    ...
    st.markdown("""
        <div class="panel">
            ...
            <div class="radio-container">
                ...
                <input type="radio" name="image-select" value="Image 2" id="radio2" class="radio-button">
    ...
    st.markdown("""
        <div class="panel">
            <div class="form-row">
                ...
                <input class="form-input" type="text" id="user">
            </div>
            <div class="form-row">
